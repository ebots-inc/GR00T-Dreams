...
class EbotsDataConfig(BaseDataConfig):
    video_keys = ["video.cam_high", "video.cam_left_wrist", "video.cam_right_wrist"]
    state_keys = ["state.arm_l", "state.arm_l_finger", "state.arm_r", "state.arm_r_finger", "state.stage"]
    action_keys = ["action.arm_l", "action.arm_l_finger", "action.arm_r", "action.arm_r_finger", "action.stage"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0, 16]
    action_indices = list(range(16))
